...
const sections = [
    {
        ...
        en: { 
            ...
            content: "Community-operated cameras monitor Tata Steel's chimneys, watching for illegal smoke emissions and holding the company accountable.", 
            expandedContent: "These cameras, often crowdfunded or run by local action groups, serve as an independent check on Tata Steel's environmental impact. They meticulously record smoke plume activity, providing crucial evidence for discussions about pollution and regulatory compliance. The footage is often shared publicly to raise awareness."
        },
    ...
    },
    {
        ...
        en: { title: "Tata Steel's Perspective", subtitle: "Claims of progress vs. the untold story.", content: "The central hub of operations, where innovation meets tradition.", expandedContent: "Our headquarters combines traditional values with cutting-edge innovation. From this center, we coordinate global operations while developing the next generation of steel products that will shape our future." },
    ...
    },
    {
        name: "Hospital", 
        start: 65, end: 70, 
        en: { title: "Health Impacts", subtitle: "The consequences of living near a steel factory.", content: "Detailed information about health studies and local concerns.", expandedContent: "Studies have shown correlations between proximity to steel plants and increased respiratory issues, as well as concerns about long-term exposure to particulate matter and heavy metals. This section explores the available data and community health reports." },
    ...
    },
    {
        ...
        en: { title: "Two Futures", subtitle: "Shutdown like Pittsburgh, or green like Sweden?", content: "Showcasing how Tata Steel contributes to modern transportation infrastructure.", expandedContent: "Our specialized steel products are essential components in aircraft, railways, and automotive applications. Tata Steel provides custom alloys that balance weight, strength, and durability for the transportation sector." },
